...
@onready var spawn_parent := $"../../../World1/SpawnParent"
@onready var class_option: OptionButton = $Panel/ClassSelect/VBoxContainer/ClassOption
@onready var primary_option: OptionButton = $Panel/ClassSelect/VBoxContainer2/PrimaryWeaponOption
@onready var secondary_option: OptionButton = $Panel/ClassSelect/VBoxContainer3/SecondaryWeaponOption
@onready var confirm_button: Button = $Panel/ClassSelect/ConfirmBuild
